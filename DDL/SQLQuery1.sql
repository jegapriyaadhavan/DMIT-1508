...
INSERT INTO Customers(FirstName, LastName)
	VALUES ('Barbey', 'Rubble')
INSERT INTO Customers(FirstName, LastName, PhoneNumber)
	VALUES ('Wilma', 'Slghoople','(403)555-1212')
...
SELECT CustomerNumber, FirstName, LastName,
		 [Address] + ' ' + City + ',' + Province AS 'Customer Address', PhoneNumber
FROM Customers	
GO

/*
     You can check that the constraints work on the first/last name by highlighting and running these scripts. They should fail.
